import { query,add,remove,edit ,editStatus,resetPassword ,bulk_add} from '@/services/applications';
...
export default {
  ...
  effects: {
    ...
    *bulk_add({ payload, callback }, { call, put }) {
      const response = yield call(bulk_add, payload);
