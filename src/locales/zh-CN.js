export default {
  ...
  'app.company': '广州辂轺信息科技有限公司',
  'app.project': 'LORA设备管理系统',
  'app.login.login': '登录',
  'app.login.username': '账号',
  'app.login.password': '密码',
  'app.login.username.null':'用户名为空',
  'app.login.password.null':'密码为空',
  'app.login.changePassword':'修改密码',
  'app.login.oldPassword':'原密码',
  'app.login.newPassword':'新密码',
  'app.login.repeatPassword':'重复密码',
  'menu.home': '主页',
  'menu.applications': '设备',
  'menu.applications.list': '设备列表',
  'menu.applications.info.overview': '总体',
  'menu.applications.info.setting': '设置',
  'menu.applications.info.data': '数据',
  'menu.applications.info.events': '事件',
  'menu.applications.info.commands': '命令',
  'menu.applications.info.chart':'图表',
  'menu.applications.eui': '设备EUI',
  'menu.applications.name': '设备名称',
  'menu.applications.last_seen_at': '上次通讯时间',
  'menu.applications.key': 'APP Key',
  'menu.applications.prefix': '设备EUI前缀',
  'menu.applications.start_number': '开始表号',
  'menu.applications.end_number': '结束表号',
  'menu.applications.add': '添加设备',
  'menu.applications.bulk_add': '批量添加设备',
  'menu.applications.bulk_add_error': '结束表号必须大于开始表号',
  'menu.applications.delete': '删除 {name}',
  'menu.gateways': '网关',
  'menu.gateways.list': '网关列表',
  'menu.gateways.info.overview': '总体',
  'menu.gateways.info.setting': '设置',
  'menu.gateways.info.gateway_events': '事件',
  'menu.gateways.info.events': '事件',
  'menu.gateways.ID': '网关ID',
  'menu.gateways.name': '网关名称',
  'menu.gateways.status': '网关状态',
  'menu.gateways.key': 'APP Key',
  'menu.gateways.add': '新建网关',
  'menu.gateways.edit': '编辑网关',
  'menu.gateways.delete': '删除{name}',
  'menu.gateways.gateways.add':'新建网关',
  'menu.data': '数据',
  'menu.data.list':'数据',
  'form.search': '查询',
  'form.reset': '重置',
  ...
  'app.edit': '编辑',
  'app.delete': '删除',
  'app.successfully': '{type}成功',
  'app.delete.info': '确定要删除吗?',
  'app.add': '添加',
  'app.description': '描述',
  'app.is_required': '{key}不能为空',
  'app.pagination': '共 {total} 项',
  'app.created_at': '创建时间',
  'app.copy':'复制',
  'app.show':'显示',
  'app.hide':'隐藏',
  ...
  'app.inactivated':'未激活',
  'app.location':'位置',
  'app.EUIBytes.info':'设备 EUI需要 {bytes} bytes , 现在有 {now} bytes',
  'app.keyBytes.info':'APP key需要 {bytes} bytes , 现在有 {now} bytes',
  'app.gatewayIDBytes.info':'网关ID需要 {bytes} bytes , 现在有 {now} bytes',
  'app.event':'事件',
  'app.content':'内容',
  'app.all':'全部',
  'app.detail':'详情',
  ...
  'app.longitude':'经度',
  'app.altitude':'高度',
  'app.data_info':'红圈内为传感器序号',//绿色圆圈内为传感器序号
  'app.chart_info':'显示最新30条数据',
  'app.gateway.count':'网关总数',
  'app.device.count':'设备总数',
  'app.sendCommand':'发送命令',
  'app.open_valve':'开阀',
  'app.close_valve':'关阀',
  'app.receive_reply':'收到设备({id}) {type}回复',
  'app.list':'列表',
  'app.table':'表格',
