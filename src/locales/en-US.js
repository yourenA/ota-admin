export default {
  ...
  'app.company': 'AMWARE',
  'app.project': 'LORA Device Management System',
  'app.login.login': 'Login',
  'app.login.username': 'Username',
  'app.login.password': 'Password',
  'app.login.username.null':'Username is required',
  'app.login.password.null':'Password is required',
  'app.login.changePassword':'Change Password',
  'app.login.oldPassword':'Old Password',
  'app.login.newPassword':'new Password',
  'app.login.repeatPassword':'repeat Password',
  'menu.home': 'Home',
  'menu.applications': 'Devices',
  'menu.applications.list': 'Devices list',
  'menu.applications.info.overview': 'Overview',
  'menu.applications.info.setting': 'Setting',
  'menu.applications.info.events': 'Event',
  'menu.applications.info.data': 'Data',
  'menu.applications.info.commands': 'Command',
  'menu.applications.info.chart':'Chart',
  'menu.applications.eui': 'Device EUI',
  'menu.applications.name': 'Device name',
  'menu.applications.last_seen_at': 'Last communication time',
  'menu.applications.key': 'APP Key',
  'menu.applications.prefix': 'Device EUI Prefix',
  'menu.applications.start_number': 'Start number',
  'menu.applications.end_number': 'End number',
  'menu.applications.add': 'Add device',
  'menu.applications.bulk_add': 'Bulk add device',
  'menu.applications.bulk_add_error': 'End number must less than start number',
  'menu.applications.edit': 'Edit device',
  'menu.applications.delete': 'Delete {name}',
  'menu.gateways': 'Gateways',
  'menu.gateways.list': 'Gateways list',
  'menu.gateways.info.overview': 'Overview',
  'menu.gateways.info.setting': 'Setting',
  'menu.gateways.info.gateway_events': 'Event',
  'menu.gateways.info.events': 'Event',
  'menu.gateways.ID': 'Gateway ID',
  'menu.gateways.name': 'Gateway name',
  'menu.gateways.status': 'Gateway status',
  'menu.gateways.key': 'APP Key',
  'menu.gateways.add': 'Add gateway',
  'menu.gateways.edit': 'Edit gateway',
  'menu.gateways.delete': 'Delete {name}',
  'menu.gateways.gateways.add':'Add gateway',
  'menu.data': 'Data',
  ...
  'app.edit': 'Edit',
  'app.delete': 'Delete',
  'app.successfully': '{type} successfully',
  'app.delete.info': 'Are you sure to delete it ?',
  'app.add': 'Add ',
  'app.description': 'Description',
  'app.is_required': '{key} is required',
  'app.pagination': 'total {total} items',
  'app.created_at': 'Created time',
  'app.copy':'copy ',
  'app.show':'show',
  'app.hide':'hide',
  'app.online':'Online',
  ...
  'app.inactivated':'Inactivated',
  'app.EUIBytes.info':'Device EUI need {bytes} bytes , now is {now} bytes',
  'app.keyBytes.info':'APP key need {bytes} bytes , now is {now} bytes',
  'app.gatewayIDBytes.info':'Gateway ID need {bytes} bytes , now is {now} bytes',
  'app.event':'Event',
  'app.content':'Content',
  'app.all':'All',
  'app.detail':'Detail',
  ...
  'app.data_info':'The red circle is the sensor serial index',//绿色圆圈内为传感器序号
  'app.chart_info':'Show the latest 30 data',
  'app.gateway.count':'Gateway count',
  'app.device.count':'Device count',
  'app.sendCommand':'Send command',
  'app.open_valve':'Open valve',
  'app.close_valve':'Close valve',
  'app.receive_reply':'Receive {type} reply from device({id})',
  'app.list':'List',
  'app.table':'Table',
};
